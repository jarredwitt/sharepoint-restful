...
/*
Gets all list from the sharepoint site.
*/
SharePoint.prototype.getAllLists = function(){
    var url = this.root + 'lists';
    return httpGet(url, this);
};

/*
Gets list information by title. Only grabs information about the list, no items.
*/
SharePoint.prototype.getListInfoByTitle = function(title){
    var url = this.root + "lists/getbytitle('" + title + "')";
    return httpGet(url, this);
};

/*
Gets all items in the named list. 
*/
SharePoint.prototype.getListItemsByTitle = function(title){
...
*/
SharePoint.prototype.getContentTypes = function(list){
